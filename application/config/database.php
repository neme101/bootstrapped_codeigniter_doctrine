...
$db['development']['username'] = 'aucc';
$db['development']['password'] = 'aucc';
$db['development']['database'] = 'aucc';
$db['development']['dbdriver'] = 'pdo_mysql';
...
$db['production']['dbdriver'] = 'pdo_mysql';
